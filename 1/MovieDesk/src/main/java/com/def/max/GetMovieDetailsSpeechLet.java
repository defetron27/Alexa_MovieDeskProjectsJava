...
public class GetMovieDetailsSpeechLet implements SpeechletV2
{
    ...
    public SpeechletResponse onIntent(SpeechletRequestEnvelope<IntentRequest> requestEnvelope)
    {
        ...
        else if (intentName != null && intentName.equals("GetMovieCastAndCrew"))
        {
            String movieName = intent.getSlot("movieCastAndCrew").getValue();
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                if (movieCastAndCrew != null)
                                {
                                    ...
                                    if (movieCastList != null && movieCrewList != null && movieCastList.size() > 0 && movieCrewList.size() > 0)
                                    {
                                        ...
                                        String cardTitle = entry.getValue() + " Cast and Crew Details : ";

                                        String speechText = movieCastsAndCrews + " \nIf you would like to get another cast and crew details. Simply say Alexa, ask movie desk to say 'some movie name' cast and crew details.";

                                        String rePrompt = "If you would like to get another cast and crew details. Simply say Alexa, ask movie desk to say 'some movie name' cast and crew details.";
